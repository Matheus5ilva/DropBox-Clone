class DropBoxController {
    constructor() {
        ...
        this.namefilerEl = this.snackModalEl.querySelector('.filename');
    ...
    connectFirebase() {
        var firebaseConfig = {
            apiKey: "AIzaSyC-BOhJeRwZg-6_UV6__pZCfpmEQ053VeY",
            authDomain: "dropbox-clone-e33ff.firebaseapp.com",
            databaseURL: "https://dropbox-clone-e33ff.firebaseio.com",
            projectId: "dropbox-clone-e33ff",
            storageBucket: "dropbox-clone-e33ff.appspot.com",
            messagingSenderId: "1070895833485",
            appId: "1:1070895833485:web:933750c7b229d907925dc4",
            measurementId: "G-7GL88B4FF4"
        };
        // Initialize Firebase
        ...
        [...files].forEach(file => {
            promises.push(new Promise((resolve, reject) => {
                ...
                task.on('state_changed', snapshot => {
                    this.uploadProgress({
                        loaded: snapshot.byteTransferred,
    ...
    uploadProgress(event, file) {
        ...
        this.namefilerEl.innerHTML = file.name;
        this.timeleftEl.innerHTML = this.formatTimeHuman(timeleft)
    }
